...
from users.serializer import SyndicSerializer, CoproprieteSerializer, LotSerializer, CoproprietaireSerializer, DocumentCoproSerializer,DocumentSerializer

class SyndicViewSet(viewsets.ModelViewSet):
...
class DocumentCoproViewSet(viewsets.ModelViewSet):
    queryset = DocumentCopro.objects.all()
    serializer_class = DocumentCoproSerializer
